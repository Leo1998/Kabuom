...
public enum ProjectileType implements ObjectType {
    ...
    BULLET(1, 0.5f, "BULLET", 25f,/*Damage*/8, /*Range*/  8, EffectType.BLEEDING, "projektil.png", false, true, Ability.NULL, Upgrade.DEFAULTPROJECTILE),
    MISSILE(1, 0.5f, "MISSILE", 15,/*Damage*/200, /*Range*/14, EffectType.BURNING, "missileKlein.png", false, true, Ability.NULL, Upgrade.DEFAULTPROJECTILE),
    FLAME(3, 0.5f, "FLAME", 5,/*Damage*/ 8, /*Range*/ 7, EffectType.BURNING, "flame.png", false, true, Ability.NULL, Upgrade.DEFAULTPROJECTILE),
    ICE(1, 0.5f, "ICE", 5,/*Damage*/ 200, /*Range*/ 10, EffectType.SLOW, "IceBullet.png", false, true, Ability.NULL, Upgrade.DEFAULTPROJECTILE),
