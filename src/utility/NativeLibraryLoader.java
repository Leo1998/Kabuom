...
public class NativeLibraryLoader {
    ...
    private File getExtractedFile(String dirName, String fileName) {
        File idealFile = new File(System.getProperty("java.io.tmpdir") + "/kabuom/" + dirName, fileName);
        ...
        File file = new File(System.getProperty("user.home") + "/.kabuom/" + dirName, fileName);
        if (canWrite(file))
            return file;
