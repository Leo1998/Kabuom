...
public class TestView extends View {
    ...
    public void render(float deltaTime, Batch batch) {
        ...
        batch.draw(ViewManager.mgTurret, Utility.layoutX(testX2), Utility.layoutY(testY2), Utility.layoutY(200), Utility.layoutX(200), Utility.layoutX(100), Utility.layoutY(100),(float) (Utility.calculateAngleBetweenTwoPoints(Utility.layoutX(testX2+Utility.layoutX(200/2)),Utility.layoutY(testY2+Utility.layoutY(200/2)), Utility.layoutX(testX1),Utility.layoutX(testY1))+ Math.PI), 1f, 1f, 1f, 1f);
