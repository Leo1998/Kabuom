...
public class ViewManager {
    ...
    public static void load (){
        try {
            ...
            buttonMainTexture = new Texture(ViewManager.class.getResource("/textures/viewTextures/mainButton"));
            buttonPressedTexture = new Texture(ViewManager.class.getResource("/textures/viewTextures/pressedButton"));
        } catch(IOException e) {
            e.printStackTrace();
            font = null;
        }
